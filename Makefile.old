# This Makefile is for the Maypole::Plugin::Loader extension to perl.
#
...
#     NAME => q[Maypole::Plugin::Loader]
#     VERSION_FROM => q[Loader.pm]
...
AR_STATIC_ARGS = cr
DIRFILESEP = /
NAME = Maypole::Plugin::Loader
NAME_SYM = Maypole_Plugin_Loader
VERSION = 0.03
...
TO_INST_PM = Loader.pm

PM_TO_BLIB = Loader.pm \
	$(INST_LIB)/Maypole/Plugin/Loader.pm
...
DISTNAME = Maypole-Plugin-Loader
DISTVNAME = Maypole-Plugin-Loader-0.03
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3pm --perm_rw=$(PERM_RW)\
	  Loader.pm $(INST_MAN3DIR)/Maypole::Plugin::Loader.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  $(INST_LIB)/Maypole/Plugin/Loader.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         Maypole-Plugin-Loader' >> META.yml
	$(NOECHO) $(ECHO) 'version:      0.03' >> META.yml
	$(NOECHO) $(ECHO) 'version_from: Loader.pm' >> META.yml
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  Loader.pm $(INST_LIB)/Maypole/Plugin/Loader.pm 
	$(NOECHO) $(TOUCH) $@
